  ...
  return (
    <div className="min-h-screen bg-[--background] text-[--foreground]">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#FFD90020] to-transparent" />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <Button variant="outline" asChild className="border-border text-foreground hover:bg-muted h-12 px-6">
      ...
      <section id="areas" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 scroll-mt-20">
        <div className="mb-10">
          ...
          <p className="text-foreground/70 mt-2">Atendimento especializado para garantir seus direitos.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <Card key={item.title} className="bg-card border-border hover:border-[--primary]/60 transition-colors">
              <CardHeader>
              ...
              <CardContent className="text-foreground/70">{item.desc}</CardContent>
            </Card>
          ))}
        </div>
      </section>
      ...
      {/* Diferenciais */}
      <section id="diferenciais" className="bg-secondary border-y border-border scroll-mt-20">
            ...
            {["Atendimento ágil", "Estratégia personalizada", "Transparência total"].map((title) => (
              <div key={title} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">Equipe dedicada e comunicação direta para cada etapa do seu caso.</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="processo" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 scroll-mt-20">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-10">Como funciona</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={s.step} className="bg-card border-border">
              ...
              <CardContent className="text-foreground/70">{s.desc}</CardContent>
            </Card>
          ))}
        </div>
      </section>
      ...
      {/* Sobre */}
      <section id="sobre" className="bg-secondary border-y border-border scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div className="aspect-square w-full max-w-sm rounded-xl bg-card border border-border" />
          <div>
      ...
      <section id="depoimentos" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 scroll-mt-20">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Depoimentos</h2>
        <p className="text-xs text-foreground/60 mb-6">Os resultados podem variar conforme o caso. Nenhuma promessa de resultado é feita.</p>
        <div className="grid md:grid-cols-3 gap-6">
          {["Atendimento excelente e ágil.", "Resolvi meu caso com rapidez.", "Transparente do início ao fim."].map((t, i) => (
            <Card key={i} className="bg-card border-border">
              <CardContent className="pt-6 text-foreground/80">
      ...
      {/* FAQ */}
      <section id="faq" className="bg-secondary border-y border-border scroll-mt-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Perguntas frequentes</h2>
      ...
      <footer className="bg-secondary border-t border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-8 text-foreground/70">
          <div>
          ...
          <div>
            <h4 className="text-foreground font-semibold mb-2">Contato</h4>
          ...
          <div className="text-sm">
            <a href="#" className="hover:text-foreground block">Política de Privacidade</a>
            <a href="#" className="hover:text-foreground block mt-1">Aviso Legal</a>
          </div>
        </div>
        <div className="border-t border-border text-center text-xs text-foreground/60 py-4">© {new Date().getFullYear()} Advocacia. Todos os direitos reservados.</div>
      </footer>
    </div>
  );
}
